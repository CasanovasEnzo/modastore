    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      <div className="max-w-4xl mx-auto px-8 pt-32 pb-24">
        <div className="mb-16">
          ...
          <h1 className="text-5xl font-bold tracking-tight">Carrito</h1>
        </div>
            ...
            <div className="md:col-span-2 flex flex-col gap-4">
              {items.map((item) => (
                <div key={item.variantId}
                  className="flex items-center gap-5 border border-white/10 rounded-2xl p-5 hover:border-white/20 transition">
                  {/* Imagen */}
